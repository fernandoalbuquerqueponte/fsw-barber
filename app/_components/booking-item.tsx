...
const BookingItem = ({ booking }: BookingItemProps) => {
  ...
  const isBookingCofirmed = isFuture(booking.date);
        ...
        <Card className="min-w-full">
          <CardContent className="py-0 flex px-0">
            <div className="flex flex-col gap-2 py-5 flex-[3] pl-5">
              <Badge
                variant={isBookingCofirmed ? "default" : "secondary"}
                className="w-fit"
              >
                {isBookingCofirmed ? "Confirmado" : "Finalizado"}
              </Badge>
      ...
      <SheetContent className="px-0">
        ...
        <div className="px-5">
          ...
          <SheetFooter className="flex-row gap-3 mt-6">
            ...
            <Button
              disabled={!isBookingCofirmed || isDeleteLoading}
              variant="destructive"
              className="w-full"
